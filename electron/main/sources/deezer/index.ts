import type { Track, Album, Artist, SearchResult, SearchOptions, StreamInfo } from '../types';
...
export class DeezerSource extends SourceAdapter {
  ...
  private extractTracks(response: DeezerSearchResponse | null): DeezerTrackResponse[] {
    ...
    return response.data.filter((item): item is DeezerTrackResponse => item?.type === 'track');
  }
